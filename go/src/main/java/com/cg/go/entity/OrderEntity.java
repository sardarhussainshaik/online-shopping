...
public class OrderEntity {
	...
	public OrderEntity(int orderId,CustomerEntity customerOrder, ProductEntity products, double totalPrice,
	...
	public String toString() {
		return "OrderEntity [orderId=" + orderId + ", products=" + products + ", Quantity="
