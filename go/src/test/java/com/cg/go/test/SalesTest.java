...
class SalesTest {
	...
	/*
	 * @Test void testupdateProductReport() throws SalesReportException {
	 * SalesReportEntity sales = new SalesReportEntity(102,"101","Mobile",
	 * 75,50000); Optional<SalesReportEntity> sa=Optional.ofNullable(sales);
	 * when(sale.findById((long) 102)).thenReturn(sa);
	 * sales.setProductName("Iphone"); when(sale.save(sales)).thenReturn(sales);
	...
	/*
	 * @Test void testfindSalesReportByProductId() { SalesReportEntity sales = new
	 * SalesReportEntity(110,"101","Mobile", 75,50000);
