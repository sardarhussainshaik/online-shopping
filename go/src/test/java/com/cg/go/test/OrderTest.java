...
public class OrderTest {
	...
	//Add Test Case
	/*
	 * @Test void testAddOrder() throws OrderException{ ProductEntity p1=new
	 * ProductEntity(123,"santoor",245.00,"imagee","red","essentials",2,"venu",
	 * "childcare"); UserEntity u=new
	 * UserEntity("venu","1","customer","9014475650"); OrderEntity o=new
	 * OrderEntity(123,u,p1,2.0,980l,LocalDate.now(),LocalDate.now());
	 * when(order.save(o)).thenReturn(o); assertEquals(o, service.addOrder(o)); }
	 */
